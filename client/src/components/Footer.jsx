                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start">
                                ...
                                <span>No. 123, Tech City, Colombo 03,<br />Sri Lanka</span>
                            </li>
                            <li className="flex items-center">
                                ...
                                <a href="mailto:support@jobportal.lk" className="hover:text-indigo-400 transition-colors">support@jobportal.lk</a>
                            </li>
                            <li className="flex items-center">

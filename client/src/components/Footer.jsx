                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
                            Connecting talent with opportunity. We help you find the perfect job or the ideal candidate to grow your business.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link to="/find-jobs" className="text-gray-400 hover:text-indigo-400 text-sm transition-colors">
                                    Find Jobs
                                </Link>
                            </li>
                            <li>
                                <Link to="/companies" className="text-gray-400 hover:text-indigo-400 text-sm transition-colors">
                                    Companies
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="/contact" className="text-gray-400 hover:text-indigo-400 text-sm transition-colors">
                                    Contact
                                </a>
                            </li>
                        </ul>

                    ...
                    >
                        {jobs.map((job) => (
                            <motion.div
                                ...
                                whileHover={{ y: -5 }}
                                className="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col h-full group"
                            >
                                <div className="p-6 flex-grow">
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="h-10 w-10 bg-indigo-50 text-indigo-600 rounded-lg flex items-center justify-center font-bold text-lg group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                                    ...
                                    <div className="flex items-center gap-2 mb-4 text-xs font-medium text-gray-500">
                                        <span className="px-2 py-1 bg-gray-100 rounded-md border border-gray-200">{job.category}</span>
                                        <span className="px-2 py-1 bg-gray-100 rounded-md border border-gray-200">{job.budgetType}</span>
                                    </div>
                                ...
                                <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-50 rounded-b-xl flex justify-between items-center">
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center p-4 bg-gray-50 rounded-xl border border-gray-100">
                                            <div className="h-10 w-10 rounded-full bg-white flex items-center justify-center text-indigo-600 shadow-sm mr-4">
                                                <FaPhone />
                                            </div>
                                            <div>
